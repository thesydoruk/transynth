...
Placeholder-подібні токени тепер підсвічуються безпосередньо всередині translation textarea, щоб форматні маркери було легше зберігати під час редагування.
QA, як і раніше, залишається джерелом істини для перевірки `placeholder_mismatch`.
