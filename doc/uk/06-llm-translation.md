...
поради переписують щонайбільше п’ять разів; нова формулювання має виграти
порівняння з тим, що вже стоїть. Доведений дефект ліміту не має. `dryRun` на
ендпоінті лише звітує вердикти, нічого не пише.
...
1. **Після перекладу.** Рядки з витоком роду йдуть до моделі окремим проходом
   ...
   - **addressee** — NPC говорить до гравця: дію адресата перетворити на подію,
     ...
     Гілки йдуть одна за одною, не паралельно. Правку приймають, лише якщо витоку
     справді не стало: заміна чоловічого роду на жіночий на рядку гравця,
     «зробив/ла» чи ховання за «ви» не проходять ту саму перевірку — тоді
     лишається початковий варіант.
2. **Під час verify.** Витік роду — доведений дефект: він блокує підтвердження
   і рядок іде в той самий repair-прохід. Вердикт `ok` на рядку з витоком
   знижують; запропоновану правку, яка сама вносить рід, відкидають. Вгадана
   стать оповідача (евристика чи LLM) більше не є доказом — лише ручне рішення
   тримає наративний рядок.
