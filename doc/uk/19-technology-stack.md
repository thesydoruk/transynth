...
| -------------- | -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `PageHeader`   | `components/PageHeader/`   | Єдиний заголовок сторінки: назва, опис, слот для дій праворуч і опціональний рядок meta. Застосовано до GlossaryPage, ImportsPage та SettingsPage. |
