...
- Створює основні таблиці та індекси для модів, записів, вихідних рядків, перекладів, історії перекладів, термінів глосарію, джоб імпорту, QA-проблем, QA-правил, сесій, користувачів і журналу активності.
