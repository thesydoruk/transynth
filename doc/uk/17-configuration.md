...
Сторінка містить чотири вкладки:

| Вкладка                 | Вміст                                                                                |
| ----------------------- | ------------------------------------------------------------------------------------ |
| **Загальні**            | Типові мови джерела/цільова, мова інтерфейсу, світла/темна тема                      |
| **LLM / Авто-переклад** | Поточний провайдер, моделі, розмір пакету, системні прапорцел 10(тольки для читання) |
| **Дані**                | Картки швидкого доступу до Правил QA, правил TradAuto, Глосарію                      |
| **Користувачі**         | Картка до сторінки Користувачі _(тільки в multi-user mode)_                          |
