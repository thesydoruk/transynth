...
app. Bethesda and Disco Elysium are supported today; another game is a plugin, not
a fork — see [Adding a Game](17-adding-a-game.md).
...
| 16  | [Vortex Sync](16-vortex-sync.md)               | CLI: Vortex staging + game → isolated group → langpack. **Experimental, very early** |
| 17  | [Adding a Game](17-adding-a-game.md)           | The game plugin contract and how to write one                                        |
...
Each title is a plugin under `src/games/`, and its plugin decides how its mods
...
A game the app does not ship yet is a new plugin directory, not a change to the
pipeline — see [Adding a Game](17-adding-a-game.md).
