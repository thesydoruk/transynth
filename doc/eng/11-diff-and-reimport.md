...
Open **Release & Diff** from the game hub (route: `/games/:gameId/diff`).
...
| Button        | Action                                                                                      |
| ------------- | ------------------------------------------------------------------------------------------- |
| **Open Diff** | Navigates to `/games/:gameId/diff?newModId=X&oldModId=Y`; the comparison runs automatically |
...
← [Exporting](10-export.md) | [Home](README.md) | **Next: [Special Editors →](12-special-editors.md)**
