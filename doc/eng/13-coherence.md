...
Open **Consistency** from the game hub (route: `/games/:gameId/coherence`).
...
← [Special Editors](12-special-editors.md) | [Home](README.md) | **Next: [Configuration →](14-configuration.md)**
