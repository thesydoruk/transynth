...
The pipeline includes two specialised tools for content that needs more than a
simple text box: the INNR editor and the Book / HTML editor.
...
**Route:** `/games/:gameId/mods/:modId/innr`
...
← [Diff & Re-import](11-diff-and-reimport.md) | [Home](README.md) | **Next: [Coherence Checker →](13-coherence.md)**
