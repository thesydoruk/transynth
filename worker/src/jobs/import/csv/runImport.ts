/**
 * CSV ingestion loop (worker process only).
 *
 * Records are buffered and written in batches under the import write lock;
 * cancel/pause are checked between records and only take effect after the
 * current batch commits, so progress is never lost.
 */
...
import {
  ...
  markPaused,
  updateProgress,
} from '../../../../../src/import/csv/jobs';
import { iterCsvRecords } from '../../../../../src/import/csv/parse';
import type { CsvImportJob, CsvRecord, ProgressCb } from '../../../../../src/import/csv/types';
