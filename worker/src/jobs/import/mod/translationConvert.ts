/**
 * Turn strings a mod already ships in the target language into translations.
 *
 * A localized mod carries both the English and the translated text for the same
 * record, so the pair can be promoted to a translation row instead of being
 * queued for the machine translator.
 */
import type { Tx } from '../../../../../src/db';
import { logImport } from '../../../../../src/logging/loggers';
import { sqlConvertImportedStringsToTranslations } from '../../../../../src/import/bulk';
import {
