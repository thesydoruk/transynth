...
import { countScannableStrings, iterateSkipDetectWorkUnits } from '../queries';
...
export const runModSkipDetectPipeline = async (
  ...
  async function* chunkFeed(): AsyncGenerator<readonly import('../queries').ScanStringRow[]> {
