/**
 * Resolve the on-disk layout of an imported mod (plugin, extraction dir,
 * localization and pack output dirs), normalizing paths stored on another
 * host/OS. Used by voice generation and export.
 */
