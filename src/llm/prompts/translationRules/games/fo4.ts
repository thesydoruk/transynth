...
export const fo4Rules: GameRules = {
  ...
  uk: () => [
    ...
    '- synth / synths → синт / синти (андроїд Інституту). НІКОЛИ «син/сина/сини» (= son). Якщо в source є і son, і synth — обидва слова різні в перекладі.',
  ...
  verifyEn: () => [
    ...
    '- DLC04 Nuka-World raider armor: when source names faction and slot ("Operators Light Arm Armor"), translation must match. Wrong faction or rarity-only translation — "incorrect". When source is ONLY "Epic"/"Legendary"/"Rare" — translation is ONLY that tier word; do NOT expand from edid (Operators/Pack/Disciples); "Epic" → one word, verdict "ok" for «Епічна».',
    ...
    '- synth/synths → синт/синти, NEVER син/сина/сини (son). If source has both son and synth, both must appear distinctly.',
  ...
  verifyUk: () => [
    ...
    '- synth / synths → синт / синти (неологзм Інституту). НІКОЛИ «син/сина/сини» (son). Якщо в source є і son, і synth — обидва терміни мають бути різні.',
