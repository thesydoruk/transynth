...
export const fo4Rules: GameRules = {
  en: (targetLang) => [
    ...
    '- Slots: parts ["I need ", 0, " caps."] → translate words, keep slot ids.',
    ...
    '- INFO: "Paladin. Congratulations." → vocative + natural line; "You\'ve walked into a hornet\'s nest." → idiomatic target language, not literal. "How do you want to play this?" → recast, not a calque of English syntax.',
  ],
  uk: () => [
    '### СТИЛЬ, ТОН ТА АТМОСФЕРА (Fallout 4):',
    '- Сетинг: постійна Співдружність (Бостон), 2287 р. Мова прагматична, зношена, подекуди з чорним гумором; жива розмовна 2010-х, не радянський дубляж і не інтернет-сленг.',
    ...
    '- Діалоги (grup: INFO/DIAL): адаптація, не підрядник; жива розмовна мова для озвучення.',
    ...
    '- Слоти: ["I need ", 0, " caps."] → ["Мені потрібно ", 0, " кришок."] (індекси не чіпати).',
    ...
    '- INFO: "Paladin. Congratulations." → "Паладин. Вітаю."; "You\'ve walked into a hornet\'s nest." → "Ласкаво просимо до осиного гнізда." (ідіома, не дослівно); "How do you want to play this?" → "Як діятимемо?" (не «Як ви хочете це зіграти?»).',
  ...
  verifyEn: () => [
    ...
    '- Spoken INFO/DIAL calque (English word order kept, dead formal phrasing) — "suspicious" even if the facts match. Already natural spoken lines — "ok". Do not apply this to UI/item names.',
    '- Wasteland NPC addressing the player with formal plural "you" (except Institute / Amari / Li / Curie / X6-88 / Maxson / Kells / companion Codsworth) — "suspicious". Gendered "you are ready-masc/fem" — "suspicious". Recast, do not switch to formal-you to hide gender.',
    '- Courser → hunter term per glossary, never "cursor". Disciples → that glossary name, never "Disciplines". Squire → squire-armiger term, not a calque. Softened fuck→mild curse, or "блядь" spelling — "suspicious".',
  ],
  verifyUk: () => [
