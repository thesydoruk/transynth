...
export const fo4Rules: GameRules = {
  ...
  verifyEn: () => [
    ...
    '- DLC04 Nuka-World raider armor (edid/source Operators/Pack/Disciples): translation MUST name the same faction and slot as source. "Operators … Arm Armor" with Disciples/Pack-only wording, or translation that is only "Epic"/"Legendary" — "incorrect" (wrong row); suggestion null.',
  ...
  verifyUk: () => [
    ...
    '- DLC04 броня рейдерів Ядер-Світу (edid/source Operators/Pack/Disciples): translation має називати ту саму фракцію і слот, що source. «Operators … Arm Armor» з «Адептами»/«Зграєю» замість «Операторів», або переклад лише «Епічна»/«Легендарна» — "incorrect" (чужий рядок); suggestion null. «The Pack» → «Зграя» (glossary).',
