...
export const englishGenderRules = (): string[] => [
  ...
  '- Terms of endearment to the player (honey, sweetheart, darling, dear, love): use a gender-neutral vocative, and keep the rest of the line gender-neutral too — no gendered second-person verb or adjective next to the vocative.',
];
...
export const englishVerifyGenderRules = (): string[] => [
  ...
  '- Gendered vocatives of endearment to the player, or a neutral vocative still paired with a gendered second-person verb/adjective → "suspicious"; neutralize the whole line.',
];
