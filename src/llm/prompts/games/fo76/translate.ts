...
Вхідний об'єкт:
{
  ...
  "items": [
    ...
    { "id": 109, "parts": ["Responders needed at the airport."], "grup": "MESG" },
    { "id": 110, "parts": ["Place your C.A.M.P."], "grup": "MESG" },
    { "id": 111, "parts": ["Are you ready?"], "grup": "INFO", "context": "Rose" }
  ]
}
...
Валідна відповідь (ЛИШЕ чистий JSON):
{
  "items": [
    ...
    { "id": 109, "parts": ["Рятувальники потрібні в аеропорту."] },
    { "id": 110, "parts": ["Розмістіть свій C.A.M.P."] },
