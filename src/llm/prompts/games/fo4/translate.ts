...
- **Звертання**:
  - **Формальна жіноча адреса**: «Ma'am», «Madam(e)», «mum» (звертання до жінки, не «мама-рідна») → «пані» / «мадам»; **НІКОЛИ** «мама» / «мамо», якщо в source немає «mother» / «mom» / «mum made» тощо.
...
- **Фракції** (іменник vs прикметник): «Institute» → «Інститут» / «інститутський…»; «Railroad» → «Підземка» / «підземний…» (без лапок); «Gunner» (одн.) → «стрілець»; «Gunners» (мн.) → «Стрільці». «Glory to Atom!» → «Слава Атому!».
- **Омоніми**: «Sentry Bot» (істота) ≠ «Sentry» у mod-назві (трансліт «Сентрі»); «Mongrel» → «Дикий пес», не ім'я «Собака» (Dogmeat).
