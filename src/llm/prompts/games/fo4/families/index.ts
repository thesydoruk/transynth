...
export const FO4_UK_FAMILY_TRANSLATE: Record<Exclude<LlmPromptFamily, 'default'>, string> = {
...
export const FO4_UK_FAMILY_VERIFY: Record<Exclude<LlmPromptFamily, 'default'>, string> = {
