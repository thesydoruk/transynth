/**
 * Канонічний глосарій Fallout 3 (en → uk) для standalone-промптів.
 *
 * Самодостатня копія для довідки та ручного редагування.
 * Ніде не імпортується поза підпапкою standalone/fo3/.
 */
export type GlossaryEntry = { term: string; translation: string };

export const FALLOUT3_UK_GLOSSARY: GlossaryEntry[] = [
  {
    term: 'caps',
    translation: 'кришки',
  },
