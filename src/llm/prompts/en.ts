...
export const buildEnglishVerifySystemPrompt = (
  ...
  return [
    ...
    '  • source is an item name / UI line / dialogue but translation is only a rarity or category word ("Epic", "Legendary", "Rare", etc.) with none of the key words from source;',
