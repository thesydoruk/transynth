...
import type { EspGrupInfo, EspRecordsPage, EspRecordView, EspSubrecordView } from './types/index.js';
...
export class EspExplorer {
  ...
  private buildRecordView(
    ...
    if (compressed) {
      ...
      recordData = this.buf.subarray(recOffset + RECORD_HEADER_SIZE, recOffset + RECORD_HEADER_SIZE + dataSize);
    }
