...
import { parsePoBuffer, type PoEntry } from '../../../formats/po';
import {
  discoAudioDir,
...
import { discoPoEntryStorageKey } from './poPath';
import { classifyDiscoPoSignature } from './poSignature';
import { discoPoLocaleText } from './poText';
