import { DISCO_VOICE_MARKUP } from '../voice/markup';
...
describe('TTS after restore', () => {
  it('does not collapse f****t to ft when unwrapping disco italics', () => {
    expect(
      stripVoiceNonSpeechBlocks("I'm not dying here, f****t. You *belong*.", DISCO_VOICE_MARKUP),
    ).toBe("I'm not dying here, faggot. You belong.");
  });
