...
import type { VoiceSourceRow, VoiceTranslationRow } from '../../../voice/loadVoiceTranslations';
import {
  pickVoiceTtsReference,
  type SpeakerRefCacheEntry,
} from '../../../voice/pickVoiceTtsReference';
import { prepareReferenceAudio } from '../../../voice/prepareReferenceAudio';
import {
...
import { resolveTtsLanguage, type TtsReferenceMode } from '../../../voice/voiceToolPaths';
    ...
    const tts = await synthesizeWav(
      ...
      picked.clips.map((clip, index) => {
        ...
        return {
          ...
          speakerText: stripVoiceNonSpeechBlocks(spokenEn, DISCO_VOICE_MARKUP) || undefined,
        };
      }),
      {
        baseUrl: ttsBaseUrl,
