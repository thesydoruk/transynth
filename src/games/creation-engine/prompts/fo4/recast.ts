 ...
 */
import { UK_WASTELAND_GENDER_RECAST_EXAMPLES_FULL } from '../../../../llm/prompts/genderRules';
...
- \`any\`, \`field: "RNAM"\`, адресат Player з порожнім / unknown gender — спільний рядок Нейта і Нори. «готова» так само зламано, як «готовий»: це вгадування Нори, не метадані. Якщо присудок ставить рід (минулий час, прикметник, дієприкметник, «сам/сама», «прийшов», «здувся») — перепиши **весь** присудок. Спочатку теперішній час; далі наказ, стан, іменник, результат. Не слеш «зробив/ла», не дві статі в одному рядку, не «ви»/«будьте» як милиця роду.
...
- Після правки проглянь **увесь** рядок, не лише кінець: минулий час і «сам/знайшов/сказав/привернув». Якщо рід гравця або unknown мовця світиться — перепиши ще раз. Не канцелярит. Не міняй хто зробив що.
...
- Гравець до Отця / вченого / Кюрі / X6 теж на ви. Одна сцена — один регістр: рейдер/Дарла/Скінні лише ти. Одна репліка не мішає «можете» з «май на увазі»: промова Отця / натовп — «Знайте», «можете».
...
### МЕЖІ
- Не міняй сенс, лайку, глосарій і факти. Не згладжуй hell/fuck у Кейт до «біса». Не розжовуй RNAM.
