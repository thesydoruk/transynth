    ...
    <>
      <div className={parentS.section}>
        ...
        <div className={parentS.fieldGrid}>
          <label className={parentS.fieldLabel} htmlFor="settings-src-lang">
            {t('settings.general.srcLang')}
          </label>
          <select
            id="settings-src-lang"
            className={s.select}
            value={srcLang}
            onChange={(event) => handleSrcLang(event.target.value)}
          >
          ...
          <label className={parentS.fieldLabel} htmlFor="settings-tgt-lang">
            {t('settings.general.tgtLang')}
          </label>
          <select
            id="settings-tgt-lang"
            className={s.select}
            value={tgtLang}
            onChange={(event) => handleTgtLang(event.target.value)}
          >
            {CONTENT_LANGUAGE_OPTIONS.map((language) => (
              <option key={language.code} value={language.code}>
                {language.label}
      ...
      <div className={parentS.section}>
        ...
        <div className={parentS.fieldGrid}>
          <label className={parentS.fieldLabel} htmlFor="settings-ui-lang">
            {t('settings.general.uiLang')}
          </label>
          <select
            id="settings-ui-lang"
            className={s.select}
