            ...
            return (
              <>
                ...
                >
                  ...
                  <td className={s.td}>
                    <Bar
                      value={Number(mod.translated)}
                      max={Number(mod.total)}
                  ...
                  <td className={Number(mod.qa_issues) > 0 ? s.qaHasIssues : s.qaNoIssues}>
                    {mod.qa_issues}
                  </td>
                </tr>
                {isOpen && (
