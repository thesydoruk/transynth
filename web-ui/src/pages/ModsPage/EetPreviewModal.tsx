...
import { api, type EetImportJob, type EetPreviewRow } from '../../api';
...
interface EetPreviewModalProps {
  job: EetImportJob;
  onClose: () => void;
...
/** Preview modal for EET imports with language selection and sample rows. */
export const EetPreviewModal = ({ job, onClose, onConfirm }: EetPreviewModalProps) => {
