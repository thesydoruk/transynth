/**
 * GameHubPage — workspace overview for one game.
 *
 * Route: /games/:gameId
 *
 * Header, stats, one Release path (Diff → export), then Translate / Discover /
 * Quality / Terms cards and a short recent-mods list.
 */
    ...
    <div className={s.page}>
      ...
      <div className={s.header}>
        ...
        <div className={s.headerInfo}>
          ...
          <Link to="/settings?tab=voice" className={s.voiceLink}>
        ...
        <section className={s.releasePanel} aria-label={t('gameHub.releasePanelTitle')}>
          ...
          <div className={s.releaseSteps}>
            <div className={s.releaseStep}>
              ...
              <Link to={`/games/${gameId}/diff`} className={s.releaseActionPrimary}>
      ...
      <GameHubNav gameId={gameId} isModsLoading={isModsLoading} modCount={stats?.modCount ?? 0} />
