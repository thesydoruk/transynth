...
export const CoherencePage = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['coherence', gameId, targetLang, page],
    queryFn: () => api.coherence.list({ targetLang, limit: PAGE_SIZE, offset, game: gameId }),
    enabled: !!gameId,
  ...
  const resolveMut = useMutation({
    mutationFn: ({
      ...
      signature: string;
      translation: string;
    }) => api.coherence.resolve(sourceText, signature, translation, targetLang, gameId),
    onSuccess: () => {
  ...
  const resolveAllMut = useMutation({
    mutationFn: () => api.coherence.resolveAll(targetLang, gameId),
    onSuccess: (result) => {
